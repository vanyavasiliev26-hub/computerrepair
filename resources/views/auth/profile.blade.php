                    ...
                    <div class="orders-body">
                                ...
                                <table class="orders-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <a href="{{ route('order.show', $order->id) }}" class="btn-icon" title="Просмотр">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                @if($order->status == 'new')
                                                    <form method="POST" action="{{ route('order.cancel', $order->id) }}" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        @else
                            <div class="empty-orders">
                                ...
                                <a href="{{ route('order') }}" class="btn-order">Создать заявку</a>
                            </div>
                        @endif
                    </div>
                </div>
