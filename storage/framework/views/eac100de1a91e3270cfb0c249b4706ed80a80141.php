...
<?php $__env->startSection('title', 'Новая заявка'); ?>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('order.store')); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="service_id" id="service_id" class="form-select <?php $__errorArgs = ['service_id'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="preferred_date" id="preferred_date" class="form-control <?php $__errorArgs = ['preferred_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('preferred_date')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('orders')); ?>" class="btn btn-secondary">Отмена</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\localhost\resources\views/order/create.blade.php ENDPATH**/ ?>