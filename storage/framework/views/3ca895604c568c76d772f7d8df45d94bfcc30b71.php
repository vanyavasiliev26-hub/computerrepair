...
<?php $__env->startSection('title', $service->name . ' - Ремонт компьютеров'); ?>
...
<div class="service-detail-page">
    <div class="container">
        ...
        <nav class="breadcrumb-nav">
            ...
            <a href="<?php echo e(route('services')); ?>">Услуги</a> /
                    ...
                    <div class="service-gallery">
                        <div class="main-image">
                            <?php if($service->image && file_exists(public_path($service->image))): ?>
                                <img src="<?php echo e(asset($service->image)); ?>" alt="<?php echo e($service->name); ?>" id="mainImage">
                            <?php else: ?>
                ...
                <div class="col-lg-6">
                    <div class="service-info">
                        ...
                        <div class="service-price-large">
                            Стоимость: <span><?php echo e(number_format($service->price, 0, '', ' ')); ?> ₽</span>
                        </div>
                        ...
                        <div class="service-actions">
                            <a href="<?php echo e(route('order')); ?>?service=<?php echo e($service->id); ?>" class="btn-order">
        ...
        <div class="other-services">
            ...
            <div class="other-services-grid">
                ...
                <div class="other-service-card">
                    ...
                    <h4><?php echo e($other->name); ?></h4>
                    <p><?php echo e(number_format($other->price, 0, '', ' ')); ?> ₽</p>
                    <a href="<?php echo e(route('service.show', $other->id)); ?>">Подробнее →</a>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\localhost\resources\views/service-detail.blade.php ENDPATH**/ ?>